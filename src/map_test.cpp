...
TEST_F(MapTest, DefaultAllocatorTest) {
    ...
    ASSERT_EQ(10, map.front().second);
    //ASSERT_EQ(10, map.back().second);
    ASSERT_EQ(1, map.size());

    ASSERT_EQ(0, map["nine"]);
    ASSERT_EQ(0, map.front().second);
    //ASSERT_EQ(10, map.back());
